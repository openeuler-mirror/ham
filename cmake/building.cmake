if(NOT DEFINED CMAKE_BUILD_TYPE OR CMAKE_BUILD_TYPE STREQUAL "x" OR CMAKE_BUILD_TYPE STREQUAL "debug")
...
if(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 7.3)
        ...
        set(HAM_CXX_STANDARD "-std=c++11")
    else()
        message(STATUS "Compiler version is compatible (>= 7.3)")
        set(HAM_CXX_STANDARD "-std=c++17")
...
set(CXX_COMMON_FLAGS "${CXX_COMMON_FLAGS} ${HAM_CXX_STANDARD} -fno-omit-frame-pointer ${HUAWEI_SECURE_BUILD_FLAGS}")

set(CMAKE_C_FLAGS_DEBUG "${C_COMMON_FLAGS} -O0 -ggdb3 -g -lrt -ldl -lm -DDEBUG -DMIGRATE_TEST -DENV_HCCS")
set(CMAKE_C_FLAGS_RELEASE "${C_COMMON_FLAGS} -O2 -D_FORTIFY_SOURCE=2 -g -DNDEBUG=1 -lrt -ldl -lm -DMIGRATE_TEST -DENV_HCCS")
...
SET(HAM_INSTALL_INCLUDE_PERMISSIONS
        OWNER_READ OWNER_WRITE
        GROUP_READ
        WORLD_READ)

SET(HAM_INSTALL_LIB_PERMISSIONS
        OWNER_READ OWNER_WRITE OWNER_EXECUTE
        GROUP_READ GROUP_EXECUTE
        WORLD_READ WORLD_EXECUTE)

SET(HAM_INSTALL_EXE_PERMISSIONS
        OWNER_READ OWNER_WRITE OWNER_EXECUTE
        GROUP_READ GROUP_EXECUTE
        WORLD_READ WORLD_EXECUTE)
